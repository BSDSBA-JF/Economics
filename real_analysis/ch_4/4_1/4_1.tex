% Problem 1
\begin{problem}
	E Verify that the definition of equality on the integers is reflexive, symmetric, and transitive.
\end{problem}
\begin{proof}
...
% Problem 2
\begin{problem}
E Show the definition of negation on the itegers is well-defined in the sense that if $(a \minus b) = (a' \minus  b')$, then $-(a \minus b) = -(a' \minus b').$
...
%Problem 3
\begin{problem}
	E Show that $(-1) \times a = -a$ for every integer $a$.
\end{problem}
\begin{proof}
...
% Problem 4
\begin{problem}
	E Prove the remaining identities in Proposition 4.1.6. For all of the laws of algebra for the integers, 
...
% Problem 5
\begin{problem}
	H Let $a, b \in \mathbb{Z}$ Suppose $ab = 0.$ Then, $a = 0$ or $b = 0.$
\end{problem}
\begin{proof}
	Suppose that $ab = 0.$
...
% Problem 6
\begin{problem}
	M Let $a, b, c \in \mathbb{Z}$ with $c \neq 0.$ If $ac = bc$, then $a = b.$
\end{problem}
...
% Problem 7
\begin{problem}
	E Prove the properties of order for the integers. For all the propositions, let $a, b, c \in \mathbb{Z}.$
\end{problem}
\begin{multicols}{2}
\begin{proposition}
