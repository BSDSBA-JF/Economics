% Problem 1
\begin{problem}
	E Verify the basic properties of absolute value and distance. Let $x, y, z \in \mathbb{Q}.$
\end{problem}
\begin{multicols}{2}
\begin{proposition}
...
% Probelm 4
\begin{problem}{E}
(Properties of Exponentiation I). Let $x, y$ be rational numbers. Let $n, m$ be natural numbers. The following properties hold.
\end{problem}
...
% Probelm 5
\begin{problem}{E}
(Properties of Exponentiation I). Let $x, y$ be rational numbers. Let $n, m$ be integers. The following properties hold.
\end{problem}
